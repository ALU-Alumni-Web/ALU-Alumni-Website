...
<section className='w-5/6 md:w-1/2 border-2'>
      ...
      {special?
      <div className=' flex flex-col  justify-center '>
      <><h1 className='flex items-center justify-between border-2 border-b-0 border-r-0 border-l-0 '><span className='ml-5' >BUSINESS ENTHUSIATS</span> <a href="https://www.linkedin.com/mynetwork/"><img className='mr-3' src={add} alt="" /> </a> </h1>
      <h1 className='flex items-center justify-between border-2 border-b-0 border-r-0 border-l-0'><span className='ml-5'>GLOBAL CHALLENGES</span>  <a href="https://www.linkedin.com/mynetwork/"><img className='mr-3' src={add} alt="" /> </a> </h1>
</>
      </div>
      :null}

...
const GetInvolved = () => {
  ...
  return (
    <section className="flex flex-col justify-center items-center mt-10">
      ...
      <div>
        <h1 className="flex items-center justify-center font-bold text-blue-200">
          JOIN GROUPS
        </h1>
        ,
        <div className="flex flex-col justify-center items-center w-screen">
          <section className="w-5/6 md:w-1/2 border-2">
            ...
            {regional ? (
              <div className="flex flex-col  justify-center ">
                <>
                  <h1 className="flex items-center justify-between border-2 border-b-0 border-r-0 border-l-0 ">
                    <span className="ml-5">WEST AFRICA</span>{" "}
                    <a href="https://www.linkedin.com/mynetwork/">
                      <img className="mr-3" src={add} alt="" />{" "}
                    </a>{" "}
                  </h1>
                  <h1 className="flex items-center justify-between border-2 border-b-0 border-r-0 border-l-0">
                    <span className="ml-5">RWANDA</span>{" "}
                    <a href="https://www.linkedin.com/mynetwork/">
                      <img className="mr-3" src={add} alt="" />{" "}
                    </a>{" "}
                  </h1>
                  <h1 className="flex items-center justify-between border-2 border-b-0 border-r-0 border-l-0">
                    <span className="ml-5">ZIMBABWE</span>{" "}
                    <a href="https://www.linkedin.com/mynetwork/">
                      <img className="mr-3" src={add} alt="" />{" "}
                    </a>
                  </h1>
          ...
          <section className="w-5/6 md:w-1/2 border-2">
            <div className="flex items-center justify-between">
              ...
              <button onClick={() => setSpecial(!special)}>
                {" "}
                <img src={arrow} alt="" />{" "}
              </button>
            </div>
            {special ? (
              <div className=" flex flex-col  justify-center ">
                <>
                  <h1 className="flex items-center justify-between border-2 border-b-0 border-r-0 border-l-0 ">
                    <span className="ml-5">BUSINESS ENTHUSIATS</span>{" "}
                    <a href="https://www.linkedin.com/mynetwork/">
                      <img className="mr-3" src={add} alt="" />{" "}
                    </a>{" "}
                  </h1>
                  <h1 className="flex items-center justify-between border-2 border-b-0 border-r-0 border-l-0">
                    <span className="ml-5">GLOBAL CHALLENGES</span>{" "}
                    <a href="https://www.linkedin.com/mynetwork/">
                      <img className="mr-3" src={add} alt="" />{" "}
                    </a>{" "}
                  </h1>
          ...
          <section className="w-5/6 md:w-1/2 border-2">
            ...
            {other ? (
              <div className=" flex flex-col  justify-center ">
                <>
                  <h1 className="flex items-center justify-between border-2 border-b-0 border-r-0 border-l-0">
                    <span className="ml-5">NEW GRADS</span>{" "}
                    <a href="https://www.linkedin.com/mynetwork/">
                      <img className="mr-3" src={add} alt="" />{" "}
                    </a>
                  </h1>
      ...
      <button className="bg-red-200 text-white font-semibold mt-5 h-8 w-40">
        CREATE A GROUP
      </button>
    </section>
  );
